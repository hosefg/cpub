...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <header class=" bg-gray-900">
            <nav class=" container flex items-center bg-gray-900 py-9 mx-auto">
                ...
                <ul class="hidden sm:flex flex-1 justify-end items-center gap-7 text-gray-50 text-base mr-5 font-sans">
        ...
        <div class=" container-2xl flex items-center bg-zinc-600 mx-auto">
            <div class=" flex items-center mx-44 my-28">
                <img class="flex items-center"src="https://cdn.discordapp.com/attachments/711190437922209833/946664293779243048/unknown.png" alt="">
            </div>
